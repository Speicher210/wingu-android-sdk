...
dependencies {
  compile 'com.github.Speicher210.wingu-android-sdk:sdk:3.2.0'
  compile 'com.github.Speicher210.wingu-android-sdk:component-video:3.2.0' // optional
  compile 'com.github.Speicher210.wingu-android-sdk:qrcodescanner:3.2.0' // optional
}
```
...
WinguSDKBuilder.with(this, YOUR_WINGU_API_KEY)
  ...
  .build()
```
Both functions `nfc` and `eddystoneUrl` are overloaded. Second funtction variant has argument that can be used to create custom activity intent. Be default `ChannelsDetailsActivity` is displayed.
